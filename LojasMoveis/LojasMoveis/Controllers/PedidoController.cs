...
namespace LojasMoveis.Controllers
{
    public class PedidoController : Controller
    {
        ...
        public IActionResult Checkout(Pedido pedido)
        {
            ...
            {
                ModelState.AddModelError("", "Seu carrinho está vazio. Explore nossa seleção de móveis para criar o ambiente ideal.");
            }
            ...
            foreach (var item in items)
            {
                ...
                precoTotalPedido += (item.Movel.Preco * item.Quantidade);
            }
